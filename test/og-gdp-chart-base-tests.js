...
function runBaseTests() {
  og_gdp_chart_1 = document.getElementById('og_gdp_chart_1');

  suite('Base Automation Tests for og-gdp-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-gdp-chart fixture is created', function() {
      assert.isTrue(document.getElementById('og_gdp_chart_1') !== null);
    });
